...
class ProductPage(BasePage):
    ...
    info_wrapper = ".//ancestor::form[@class='info-wrapper add-bask-form-list ']"   # Локатор Кнопки добавить в корзину
    button_add_to_card = "//button[@class ='to-cart-btn elem-to_cart']"
